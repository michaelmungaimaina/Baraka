package mich.gwan.baraka.activities.spanner;
...
import mich.gwan.baraka.adapters.pdf.PDFSpanner;
import mich.gwan.baraka.adapters.spanner.SpannerSaleRecyclerAdapter;
import mich.gwan.baraka.databinding.ActivitySpannersalesListBinding;
...
import mich.gwan.baraka.model.spanner.SpannerSale;
...
public class SpannerSaleListActivity extends AppCompatActivity implements PDFSpanner.OnDocumentClose{
    ...
    private String path(){
        ...
        {
            path = Environment.getExternalStorageDirectory() + "/Sarensa/Baraka/" + LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyyMMdd_HHmmss"))+"_spanner.pdf";
        }
        return path;
    }
    ...
    public void generateEXCEL(){
        ...
        String filename = m.format(t) + "_Baraka_spanner_sale_data.xls";
