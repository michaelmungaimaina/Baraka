package mich.gwan.baraka.activities.gas;
...
import mich.gwan.baraka.adapters.gas.GasSaleRecyclerAdapter;
import mich.gwan.baraka.adapters.pdf.PDFBolt;
import mich.gwan.baraka.adapters.pdf.PDFGas;
import mich.gwan.baraka.databinding.ActivityGassalesListBinding;
...
import mich.gwan.baraka.model.gas.GasSale;
...
public class GasSaleListActivity extends AppCompatActivity implements PDFGas.OnDocumentClose {
    ...
    private String path(){
        ...
        {
            path = Environment.getExternalStorageDirectory() + "/Sarensa/Baraka/" + LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyyMMdd_HHmmss"))+"_gas.pdf";
        }
        return path;
    }
    ...
    public void generateEXCEL(){
        ...
        String filename = m.format(t) + "_Baraka_gas_sale_data.xls";
