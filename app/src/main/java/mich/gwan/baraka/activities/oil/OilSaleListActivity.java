package mich.gwan.baraka.activities.oil;
...
import mich.gwan.baraka.R;
import mich.gwan.baraka.activities.LoginActivity;
import mich.gwan.baraka.activities.bolt.BoltSaleListActivity;
import mich.gwan.baraka.adapters.oil.OilSaleRecyclerAdapter;
import mich.gwan.baraka.adapters.pdf.PDFBolt;
import mich.gwan.baraka.adapters.pdf.PDFOil;
import mich.gwan.baraka.databinding.ActivityOilsalesListBinding;
import mich.gwan.baraka.helpers.RecyclerTouchListener;
import mich.gwan.baraka.model.allsales.AllSales;
import mich.gwan.baraka.model.bolt.BoltSale;
import mich.gwan.baraka.model.oil.OilSale;
import mich.gwan.baraka.sql.DatabaseHelper;
...
public class OilSaleListActivity extends AppCompatActivity implements PDFOil.OnDocumentClose {
    ...
    private String path(){
        ...
        {
            path = Environment.getExternalStorageDirectory() + "/Sarensa/Baraka/" + LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyyMMdd_HHmmss"))+"_oil.pdf";
        }
        return path;
    }
    ...
    public void generateEXCEL(){
        ...
        String filename = m.format(t) + "_Baraka_oil_sale_data.xls";
        String filePath = Environment.getExternalStorageDirectory().getPath() + "/Sarensa/Baraka/" + filename;
        ...
        builder.setTitle("SUCCESS")
                ...
                .setPositiveButton(android.R.string.ok,new DialogInterface.OnClickListener() {
                    ...
                    {
                        File dir = new File(Environment.getExternalStorageDirectory(), "/Sarensa/Baraka/");
