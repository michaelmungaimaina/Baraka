package mich.gwan.baraka.activities.admin.ui.gallery;
...
import mich.gwan.baraka.adapters.AllSale.AllsaleRecyclerAdapter;
import mich.gwan.baraka.adapters.pdf.PDFUtility;
import mich.gwan.baraka.databinding.FragmentGalleryBinding;
...
public class GalleryFragment extends Fragment implements PDFUtility.OnDocumentClose{
    ...
    private String path(){
        ...
        {
            path = Environment.getExternalStorageDirectory() + "/Sarensa/Baraka/" + LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyyMMdd_HHmmss"))+"_AllSales.pdf";
        }
        return path;
    }
   ...
   // private void deleteItem(int position) {
    ...
    public void generateEXCEL(){
        ...
        String filename = m.format(t) + "_Baraka_allsale_data.xls";
