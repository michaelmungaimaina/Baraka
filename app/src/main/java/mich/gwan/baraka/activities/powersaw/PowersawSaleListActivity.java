package mich.gwan.baraka.activities.powersaw;
...
import mich.gwan.baraka.adapters.pdf.PDFPowersaw;
import mich.gwan.baraka.adapters.powersaw.PowersawSaleRecyclerAdapter;
import mich.gwan.baraka.databinding.ActivityPowersawsalesListBinding;
...
import mich.gwan.baraka.model.powersaw.PowersawSale;
...
public class PowersawSaleListActivity extends AppCompatActivity implements PDFPowersaw.OnDocumentClose{
    ...
    private String path(){
        ...
        {
            path = Environment.getExternalStorageDirectory() + "/Sarensa/Baraka/" + LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyyMMdd_HHmmss"))+"_prwsaw.pdf";
        }
        return path;
    }
    ...
    public void generateEXCEL(){
        ...
        String filename = m.format(t) + "_Baraka_powersaw_sale_data.xls";
