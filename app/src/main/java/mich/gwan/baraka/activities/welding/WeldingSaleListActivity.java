package mich.gwan.baraka.activities.welding;
...
import mich.gwan.baraka.adapters.pdf.PDFWelding;
import mich.gwan.baraka.adapters.welding.WeldingSaleRecyclerAdapter;
import mich.gwan.baraka.databinding.ActivityWeldingsalesListBinding;
...
import mich.gwan.baraka.model.welding.WeldingSale;
...
public class WeldingSaleListActivity extends AppCompatActivity implements PDFWelding.OnDocumentClose{
    ...
    private String path(){
        ...
        {
            path = Environment.getExternalStorageDirectory() + "/Sarensa/Baraka/" + LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyyMMdd_HHmmss"))+"_welding.pdf";
        }
        return path;
    }
    ...
    public void generateEXCEL(){
        ...
        String filename = m.format(t) + "_Baraka_welding_sale_data.xls";
