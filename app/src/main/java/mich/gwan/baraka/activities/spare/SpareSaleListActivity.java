package mich.gwan.baraka.activities.spare;
...
import mich.gwan.baraka.adapters.pdf.PDFSpare;
import mich.gwan.baraka.adapters.spare.SpareSaleRecyclerAdapter;
import mich.gwan.baraka.databinding.ActivitySparesalesListBinding;
...
import mich.gwan.baraka.model.spare.SpareSale;
...
public class SpareSaleListActivity extends AppCompatActivity implements PDFSpare.OnDocumentClose{
    ...
    private String path(){
        ...
        {
            path = Environment.getExternalStorageDirectory() + "/Sarensa/Baraka/" + LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyyMMdd_HHmmss"))+"_spare.pdf";
        }
        return path;
    }
